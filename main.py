...
interest1 = round(aud1*(st.session_state.aud_interest_rate1/100)*(st.session_state.days/365), 4)
interest2 = round(aud2*(st.session_state.aud_interest_rate2/100)*(st.session_state.days/365), 4)
...
interest1 = round(hkd1*(st.session_state.hkd_interest_rate1/100)*(st.session_state.days/365), 4)
interest2 = round(hkd2*(st.session_state.hkd_interest_rate2/100)*(st.session_state.days/365), 4)
l.write(f"獲得利息1: {interest1}")
r.write(f"獲得利息2: {interest2}")
l.write(f"總數1: {round(hkd1+interest1, 4)}")
r.write(f"總數2: {round(hkd2+interest2, 4)}")