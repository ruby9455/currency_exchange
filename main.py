...
interest1 = round(hkd1*(st.session_state.interest_rate1/100)*(st.session_state.days/365), 4)
interest2 = round(hkd2*(st.session_state.interest_rate2/100)*(st.session_state.days/365), 4)
l.write(f"獲得利息1: {interest1}")
r.write(f"獲得利息2: {interest2}")
