...
l, r = st.columns(2)
l.number_input("賣出價1", value=4.9695, step=0.0001, key="selling_price1")
r.number_input("賣出價2", value=4.9798, step=0.0001, key="selling_price2")
...
l, r = st.columns(2)
l.number_input("買入價1", value=5.0005, step=0.0001, key="buying_price1")
r.number_input("買入價2", value=5.0108, step=0.0001, key="buying_price2")
