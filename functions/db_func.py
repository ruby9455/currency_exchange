...
from functions.shared_func import _read_toml
...
def get_mongo_client() -> MongoClient | None:
    ...
    """
    connection_str = get_mongo_connection_string()
...
def create_db(client: MongoClient, db_name: str) -> None:
    """
...
def update_data(collection, query: dict, new_values: dict) -> None:
    ...
    return result
def delete_data(collection, query: dict) -> None:
    """
